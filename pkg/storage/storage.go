...
func (s *serviceExportStorage) OnAdd(obj interface{}, _ bool) {
	handler(s, s.ws, watch.Added, obj)
}
func (s *serviceExportStorage) OnDelete(obj interface{}) {
	handler(s, s.ws, watch.Deleted, obj)
}
func (s *serviceExportStorage) OnUpdate(_, obj interface{}) {
...
func (s *endpointSliceStorage) OnAdd(obj interface{}, _ bool) {
...
func (s *endpointSliceStorage) OnDelete(obj interface{}) {
	es, ok := obj.(*discoveryv1.EndpointSlice)
	if !ok {
		// Tombstone
	...
	if es == nil || !s.hasExport(es) {
		return
	}
	handler(s, s.ws, watch.Deleted, obj)
}

func (s *endpointSliceStorage) OnUpdate(_, obj interface{}) {
	es, ok := obj.(*discoveryv1.EndpointSlice)
	if !ok || !s.hasExport(es) {
		return
	}
