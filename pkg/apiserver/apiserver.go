...
func (c completedConfig) New() (*ServiceEmitter, error) {
	...
	c.serviceExportInformer.AddEventHandler(seStorage.(cache.ResourceEventHandler))
	...
	c.endpointSliceInformer.AddEventHandler(esStorage.(cache.ResourceEventHandler))
