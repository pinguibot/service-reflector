...
func (w *Watcher) Run(ctx context.Context) error {
	...
	seInformer.AddEventHandler(cache.ResourceEventHandlerFuncs{
		AddFunc:    func(obj interface{}) { w.onServiceExportAdd(ctx, obj) },
		UpdateFunc: func(_, obj interface{}) { w.onServiceExportAdd(ctx, obj) },
		DeleteFunc: func(obj interface{}) { w.onServiceExportDelete(ctx, obj) },
	})

	esInformer.AddEventHandler(cache.ResourceEventHandlerFuncs{
		AddFunc:    func(obj interface{}) { w.onEndpointSliceAdd(ctx, obj) },
		UpdateFunc: func(_, obj interface{}) { w.onEndpointSliceAdd(ctx, obj) },
		DeleteFunc: func(obj interface{}) { w.onEndpointSliceDelete(ctx, obj) },
	})
...
func (w *Watcher) onServiceExportAdd(ctx context.Context, obj interface{}) {
...
func (w *Watcher) onServiceExportDelete(ctx context.Context, obj interface{}) {
	se, ok := toServiceExport(obj)
	if !ok {
...
func (w *Watcher) onEndpointSliceAdd(ctx context.Context, obj interface{}) {
...
func (w *Watcher) onEndpointSliceDelete(ctx context.Context, obj interface{}) {
	remoteES, ok := toEndpointSlice(obj)
	if !ok {
		if d, ok2 := obj.(cache.DeletedFinalStateUnknown); ok2 {
...
func toServiceExport(obj interface{}) (*v1beta1.ServiceExport, bool) {
